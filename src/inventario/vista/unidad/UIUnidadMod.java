...
import inventario.controlador.unidad.IUnidadMod;

public class UIUnidadMod extends javax.swing.JFrame
{
    private IUnidadMod interfaz;

    public UIUnidadMod(IUnidadMod interfaz)
    {
        initComponents();
        ...
        interfaz.cargar(this.txtUniCod, this.txtUniDes);
    }
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        interfaz.aceptar(this.txtUniDes);
