...
public class frmvisualizarhabitacion extends javax.swing.JInternalFrame {

    public frmvisualizarhabitacion() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Visualizar Habitación");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmvisualizarhabitacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmvisualizarhabitacion().setVisible(true);
            }
        });
    }
